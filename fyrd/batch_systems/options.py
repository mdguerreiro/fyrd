...
COMMON  = _OD([
    ...
    ('clean_outputs',
     {'help': 'Auto clean output files when fetching outputs',
      'default': None, 'type': bool}),
    ('cores',
     {'help': 'Number of cores to use for the job on each node',
      'default': 1, 'type': int}),
    ('modules',
...
LSF = _OD([
    ...
    ('tasks',
     {'help': 'Total number of tasks',
      'lsf': '-n {}', 'type': (str, int),
      'default': None}),
    # This is used in combination with tasks to figure out span parameter
    ('cpus_per_task',
     {'help': 'Number of CPUs per task',
      'lsf': '', 'type': (str, int),
      'default': None}),
    ('tasks_per_node',
     {'help': 'Number of tasks per node',
      ...
      'default': None}),
    # Required for nodes parameter in order to figure out number of tasks
    ('cores_per_node',
